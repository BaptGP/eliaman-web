      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-[1fr_400px] gap-12">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-secondary font-roboto whitespace-pre-line">
            ...
            <div className="rounded-2xl shadow-xl p-8 text-white bg-gradient-to-br from-green-500 to-green-600">
