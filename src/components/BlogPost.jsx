...
const BlogPost = () => {
  ...
  const metaTags = article ? getMetaTags(article) : null;

  return (
    <>
      {metaTags && (
        <Helmet>
          <title>{metaTags.metaTitle} | Eliaman</title>
          ...
          <meta property="og:url" content={metaTags.articleUrl} />
